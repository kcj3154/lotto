...
<div class="container-fluid" style="width: 84%;"><br>
	<div class="row">
		<div class="col-6">
  			...
  			<input type="text" id="codeGroupCode" name="codeGroupCode" class="form-control">
		</div>
		<div class="col-6">
			<label for="codeGroupCodeAnother" class="form-label">코드그룹 코드(Another)</label>
  			<input type="text" id="codeGroupCodeAnother" name="codeGroupCodeAnother" class="form-control" placeholder="영문(대소문자),숫자" >
		</div>
	</div>

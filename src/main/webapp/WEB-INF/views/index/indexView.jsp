...
<link rel="shortcut icon" href="/resources/user/main/template/assets/favicon.ico">
...
<%-- 					<span class="fw-bold"><c:out value="${sessName}"/></span>님 <button id="btnLogOut" name="btnLogOut" class="btn btn-sm btn-outline-dark">로그아웃</button> --%>
<!-- 				</span> -->
<%-- 			</c:if> --%>
			<h1 class="fw-bold" style="clear: both;">Index</h1>
			<h6 class="fw-bold">회원관리 / 홈페이지</h6>
		</div>
	</div>
	 ...
	 <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0 aos-init aos-animate" data-aos="fade-up" style="height:400px;">
                <article class="card card-hover text-center hover-shadow-lg overflow-hidden border-0 rounded-3">
                    ...
                    <div class="card-body pb-5 position-relative">
                        <h4 class="py-3 mb-0 fw-bold">회원관리 페이지</h4>
                    </div>
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 aos-init aos-animate" data-aos="fade-up" style="height:400px;">
                <article class="card card-hover text-center hover-shadow-lg overflow-hidden border-0 rounded-3">
                    ...
                    <!--Article text-->
                    <div class="card-body pb-5 position-relative">
                        <h4 class="py-3 mb-0 fw-bold">홈페이지</h4>
                    </div>

                    <!--Article link-->
                    <a href="/main" class="stretched-link"></a>
                </article>
            </div>
        </div>
